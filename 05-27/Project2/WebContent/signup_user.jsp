...
<body>
	...
	<div style="margin-top: 350px">
		<form method="post" action="SignupGo">
			<div class="form-row">
	    		<div class="col" style="margin-left: 500px;">
	    			<label for="formGroupExampleInput" style="font-family: 'Cute Font', cursive; font-size: 29px;">이메일</label>
	      			<input type="email" class="form-control" placeholder="Email" style="width: 380px; border: 1px solid red;" name="id">
	    		</div>
	    		<div class="col" style="margin-right: 500px;">
	    			<label for="formGroupExampleInput" style="font-family: 'Cute Font', cursive; font-size: 29px;">비밀번호</label>
	      			<input type="password" class="form-control" placeholder="Password" style="width: 380px; border: 1px solid red;" name="pw">
	    		</div>
	    		<div class="col" style="margin-left: 500px;">
	    			<label for="formGroupExampleInput" style="font-family: 'Cute Font', cursive; font-size: 29px;">전화번호</label>
	      			<input type="text" class="form-control" placeholder="- 빼고 입력" style="width: 380px; border: 1px solid red;" onKeyup="inputPhoneNumber(this);" maxlength="13" name="phone">
	    		</div>
	  			<input type="hidden" value="user" name="check">
